# Big-O Notation for Alogithm Analysis:
...
# 4. A polynomial algorithm – O(n^c) --> The nested loops cause the number of iterations to grow quadratically with n, leading to a time complexity of O(n^2).

# 5. A exponential algorithm – O(c^n) --> The loop iterates 2^n times, resulting in exponential growth in execution time as n increases.

# 6. A cuadratic algorithm – O(n^2) --> The nested loops cause the number of iterations to grow quadratically with n, leading to a time complexity of O(n^2).

# 7. A cubic algorithm – O(n^3) --> Similar to the quadratic example, the triple nested loops cause the number of iterations to grow cubically with n, resulting in a time complexity of O(n^3).
